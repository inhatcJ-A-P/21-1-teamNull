...
public class Bsubtest extends JFrame implements ActionListener{
	private String[] str = {"+", "-", "*", "/"};
	...
	public Bsubtest(String title, int width, int height, Btest btest) {
		setTitle(title);
