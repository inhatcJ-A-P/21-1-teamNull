...
//	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (obj == b3) {
			...
			String sql = "select * from member where mb_num" + " LIKE '%" + t1.getText().trim() + "%'";
			getNumSearch(sql);
		} else if (obj == b2) {
			if(memberList.getNumCheck2(t3.getText())) {
				...
				JOptionPane.showMessageDialog(null, "주민번호 중복입니다!", "메시지", JOptionPane.ERROR_MESSAGE);
			}
